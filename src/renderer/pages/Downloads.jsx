...
export default function Downloads({ onNavigate, isDark }) {
  ...
  const getStateColor = (state) => {
    ...
    if (state === 'progressing') return 'var(--accent)';
  ...
  return (
    <div style={{
      ...
      {downloads.length === 0 ? (
        ...
        <div style={{ background: cardBg, borderRadius: 'var(--radius)', border: `1px solid ${borderColor}`, overflow: 'hidden' }}>
          {downloads.map((item, index) => (
            ...
            >
              <div style={{
                ...
                height: 40,
                borderRadius: 'var(--radius)',
                background: isDark ? '#252A38' : '#E8EDF5',
                display: 'flex',
                alignItems: 'center',
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {item.state === 'progressing' && (
                  <div style={{ height: 3, background: 'var(--border)', borderRadius: 'var(--radius-xs)', marginTop: 6 }}>
                    <div style={{
                      height: '100%',
